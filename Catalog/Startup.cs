namespace Catalog
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var mongoDbSettings = this.Configuration.GetSection(nameof(MongoDBSettings)).Get<MongoDBSettings>();
            ...
            services.AddSingleton<IInMemItemRepository, MongoDBItemsRepository>();
